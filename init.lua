...
-- local tenyear_sp1 = require "packages/tenyear/pkg/tenyear_sp1"
-- local tenyear_sp2 = require "packages/tenyear/pkg/tenyear_sp2"
-- local tenyear_sp3 = require "packages/tenyear/pkg/tenyear_sp3"
-- local tenyear_sp4 = require "packages/tenyear/pkg/tenyear_sp4"
-- local tenyear_activity = require "packages/tenyear/pkg/tenyear_activity"
-- local tenyear_liezhuan = require "packages/tenyear/pkg/tenyear_liezhuan"
-- local tenyear_huicui1 = require "packages/tenyear/pkg/tenyear_huicui1"
-- local tenyear_huicui2 = require "packages/tenyear/pkg/tenyear_huicui2"
-- local tenyear_huicui3 = require "packages/tenyear/pkg/tenyear_huicui3"
...
-- local tenyear_exxinghuo = require "packages/tenyear/pkg/tenyear_exxinghuo"
