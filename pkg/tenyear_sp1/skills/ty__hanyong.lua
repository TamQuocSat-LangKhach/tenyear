local ty__hanyong = fk.CreateSkill {
  name = "ty__hanyong"
}
...
Fk:loadTranslationTable{
  ...
  [':ty__hanyong'] = '当你使用【南蛮入侵】、【万箭齐发】或♠普通【杀】时，若你已受伤，你可以令此牌造成的伤害+1，然后若你的体力值大于游戏轮数，你获得一个“燃”标记。',
  ['$ty__hanyong1'] = '找死！',
  ['$ty__hanyong2'] = '这就让你们见识见识，哈哈哈哈哈哈哈。',
}

ty__hanyong:addEffect(fk.CardUsing, {
  can_trigger = function(self, event, target, player, data)
    return target == player and player:hasSkill(ty__hanyong.name) and player:isWounded() and
