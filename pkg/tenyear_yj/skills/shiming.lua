...
Fk:loadTranslationTable{
  ...
  [':shiming'] = '每轮限一次，一名角色的摸牌阶段开始时，你可以观看牌堆顶三张牌并调整顺序，且可以将其中一张置于牌堆底，若如此做，当前回合角色可以放弃摸牌，改为对自己造成1点伤害，然后从牌堆底摸三张牌。',
...
shiming:addEffect(fk.EventPhaseStart, {
  ...
  can_trigger = function(self, event, target, player, data)
    return player:hasSkill(shiming.name) and target.phase == Player.Draw and player:usedSkillTimes(shiming.name, Player.HistoryRound) == 0
  end,
