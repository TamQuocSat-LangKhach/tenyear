...
GraphicsBox {
  id: root
  title.text: Backend.translate("#qiangzhiz-choose")
  width: 110 + Math.max((hand1.length > 0 ? hand1.length : 0) + (equip1.length > 0 ? equip1.length : 0), (hand2.length > 0 ? hand2.length : 0) + (equip2.length > 0 ? equip2.length : 0)) * 100
  height: 50 + ((hand1.length + equip1.length) > 0 ? 150 : 0) + ((hand2.length + equip2.length) > 0 ? 150 : 0)
  ...
  ColumnLayout {
    ...
    Row {
      height: 130
      spacing: 15
      visible: (hand1.length + equip1.length) > 0
    ...
    Row {
      height: 130
      spacing: 15
      visible: (hand2.length + equip2.length) > 0
    ...
    Row {
      MetroButton {
        ...
        enabled: root.selected_ids.length == 3
        onClicked: {
          close();
