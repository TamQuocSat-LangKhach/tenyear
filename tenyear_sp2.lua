...
Fk:loadTranslationTable{
  ...
  [":caiyi_inner"] = "转换技，结束阶段，你可以令一名角色选择一项并移除该选项："..
  "{1}阳：{2}1.回复X点体力；{3}2.摸X张牌；{4}3.复原武将牌；{5}4.随机执行一个已移除的阳选项；"..
  "{6}阴：{7}1.受到X点伤害；{8}2.弃置X张牌；{9}3.翻面并横置；{10}4.随机执行一个已移除的阴选项{11}。（X为当前状态剩余选项数）",
